...
<head>
    ...
    <style>
        ...
        .status-pendente { background: #ffeaa7; color: #fdcb6e; }
        .status-aprovado { background: #d1f2eb; color: #00b894; }
        .status-em_andamento { background: #dbeafe; color: #3b82f6; }
        .status-ajustes { background: #fed7aa; color: #f97316; }
        .status-finalizado { background: #d1fae5; color: #059669; }
        .status-recusado { background: #fecaca; color: #dc2626; }
...
<body>
    <div class="main-content">
        ...
        // Buscar projetos
        $query = "SELECT p.id, p.titulo, p.descricao, p.status, p.data_criacao, u.nome AS cliente, u.email AS cliente_email
                  FROM projetos p
        ...
        <div class="filter-section">
            ...
            <div class="filter-buttons">
                ...
                <a href="?status=pendente" class="filter-btn <?php echo $status_filter === 'pendente' ? 'active' : ''; ?>">
                    Pendente (<?php echo isset($status_counts['pendente']) ? $status_counts['pendente'] : 0; ?>)
                </a>
                <a href="?status=aprovado" class="filter-btn <?php echo $status_filter === 'aprovado' ? 'active' : ''; ?>">
                    Aprovado (<?php echo isset($status_counts['aprovado']) ? $status_counts['aprovado'] : 0; ?>)
                </a>
                <a href="?status=em_andamento" class="filter-btn <?php echo $status_filter === 'em_andamento' ? 'active' : ''; ?>">
                    Em Andamento (<?php echo isset($status_counts['em_andamento']) ? $status_counts['em_andamento'] : 0; ?>)
                </a>
                <a href="?status=ajustes" class="filter-btn <?php echo $status_filter === 'ajustes' ? 'active' : ''; ?>">
                    Ajustes (<?php echo isset($status_counts['ajustes']) ? $status_counts['ajustes'] : 0; ?>)
                </a>
                <a href="?status=finalizado" class="filter-btn <?php echo $status_filter === 'finalizado' ? 'active' : ''; ?>">
                    Finalizado (<?php echo isset($status_counts['finalizado']) ? $status_counts['finalizado'] : 0; ?>)
                </a>
                <a href="?status=recusado" class="filter-btn <?php echo $status_filter === 'recusado' ? 'active' : ''; ?>">
        ...
        <?php if ($result->num_rows === 0): ?>
            <div class="no-projects">
                ...
                <p>Não há projetos <?php echo $status_filter !== 'todos' ? "com status '$status_filter'" : ''; ?> no momento.</p>
            </div>
        <?php else: ?>
                ...
                <div class="project-card">
                    ...
                    <div class="project-meta">
                        ...
                        <div class="meta-item">
                            ...
                            <div class="meta-value"><?php echo date('d/m/Y H:i', strtotime($project['data_criacao'])); ?></div>
                        </div>
                        <div class="meta-item">
